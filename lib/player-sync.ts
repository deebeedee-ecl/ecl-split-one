...
export async function syncAllPlayers() {
  ...
  return {
    created: teamResults.created + freeAgentResults.created,
    updated: teamResults.updated + freeAgentResults.updated,
    skipped: teamResults.skipped + freeAgentResults.skipped,
    totalPlayers,
    teamResults,
    freeAgentResults,
  };
