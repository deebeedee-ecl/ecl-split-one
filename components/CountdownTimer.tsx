...
export default function CountdownTimer() {
  ...
  if (timeLeft.expired) {
    return (
      <div className="rounded-[2rem] border border-red-400/20 bg-gradient-to-br from-red-500/10 via-zinc-950 to-black p-8 shadow-[0_0_50px_rgba(248,113,113,0.18)]">
        <p className="text-sm font-semibold uppercase tracking-[0.35em] text-red-300">
          Registration Closed
        </p>

        <h2 className="mt-5 text-4xl font-black uppercase leading-none text-white md:text-6xl">
        ...
        <p className="mt-8 text-base leading-7 text-zinc-300 md:text-lg">
  ...
  return (
    <div
      className={`rounded-[2rem] border border-green-400/20 bg-gradient-to-br from-zinc-900 via-black to-zinc-900 p-8 shadow-[0_0_60px_rgba(74,222,128,0.14)] transition-all duration-500 ${
        pulse ? "scale-[1.01]" : "scale-100"
      }`}
    >
      <div className="flex items-center justify-between gap-4">
        <div className="inline-flex items-center gap-3 rounded-full border border-green-400/20 bg-green-400/10 px-4 py-2">
          <span
            className={`h-2.5 w-2.5 rounded-full bg-green-400 shadow-[0_0_18px_rgba(74,222,128,0.9)] transition-all duration-300 ${
        ...
        <div className="rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-zinc-400">
          Shanghai Time
        </div>
      </div>

      <h2 className="mt-6 text-4xl font-black uppercase leading-none text-white md:text-6xl">
        Time Is Running Out
      </h2>
...
function TimeCard({
  ...
  return (
    <div
      className={`rounded-[1.5rem] border p-5 text-center transition-all duration-300 ${
        highlight
